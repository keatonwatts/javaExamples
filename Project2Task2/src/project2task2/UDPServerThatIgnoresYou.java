 ...
 * operations. This .java file is the UDP server However, this UDP server will
 * randomly ignore 80% of requests Client will ask server to perform simple
 * integer arithmetic Server can add, subtract, multiply, divide and exponent
 * integers and will return value to client Arguments are separated by spaces
 */
...
public class UDPServerThatIgnoresYou {
    ...
    public static void main(String args[]) {
        ...
        //print
        System.out.println("java UDPServerThatIgnoresYou");
        ...
        try {
            ...
            while (true) {
                ...
                //make message into string remove nulls, and print the request received from client
                    ...
                    System.out.println("...but ignoring it.");
